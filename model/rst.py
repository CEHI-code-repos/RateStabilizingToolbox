...
rst(
    input_table_path = "Error_RST_Datasets.gdb/Hispanic_Diabetes",
    input_table_fields = {
        "region_id": "fips_txt",
        "event_count": "death",
        "population_count": "population_new"
    },
    input_feature_path = "Error_RST_Datasets.gdb/wa_carto_boundaries",
