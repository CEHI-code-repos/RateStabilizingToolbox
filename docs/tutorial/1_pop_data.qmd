...
Request an API Key from the Census [here](https://api.census.gov/data/key_signup.html). If
you have never used the **Census Data Retriever** before, you will be asked to provide
this API Key. This API Key will be stored for later use within a `census_api_key.txt` file 
within the same directory as `rate_stabilizing_toolbox.pyt`.
...
:::{.callout-note}
The [RSTr package](https://cehi-code-repos.github.com/RSTr/) has additional models which are 
